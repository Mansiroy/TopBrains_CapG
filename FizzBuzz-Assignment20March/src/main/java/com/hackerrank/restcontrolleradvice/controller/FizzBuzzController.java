...
//
//    if (FizzBuzzEnum.FIZZ.getValue().equalsIgnoreCase(code)) {
//      throw new FizzException("Fizz Exception Occurred", "Divisible by 3");
//    } 
//    
//    else if (FizzBuzzEnum.BUZZ.getValue().equalsIgnoreCase(code)) {
//      throw new BuzzException("Buzz Exception Occurred", "Divisible by 5");
//    } 
//    
//    else if (FizzBuzzEnum.FIZZBUZZ.getValue().equalsIgnoreCase(code)) {
//      throw new FizzBuzzException("FizzBuzz Exception Occurred", "Divisible by 3 and 5");
//    }
//
//    // Success case
//    FizzBuzzResponse response = new FizzBuzzResponse("Success", 200);
